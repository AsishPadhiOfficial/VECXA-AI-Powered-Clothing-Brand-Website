    ...
    >
      ...
      <div className="bg-gray-50 p-6 rounded-lg mb-8">
        ...
        <p>
          ...
          VECXA Technologies to create a solution that could capture detailed metrics during real skating sessions and 
      ...
      <p>
        VECXA Technologies developed a specialized single-point IMU (Inertial Measurement Unit) system embedded directly 
