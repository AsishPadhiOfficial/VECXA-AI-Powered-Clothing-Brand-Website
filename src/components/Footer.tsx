      ...
      <div className="w-full px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-10 pb-10 border-b border-gray-700">
          <div className="lg:col-span-2">
            <img 
              src="/lovable-uploads/vecxa-logo.png"
              alt="VECXA Technologies Logo" 
              className="h-32 w-auto mb-6"
            />
            <p className="text-gray-300 mb-6">
              VECXA Technologies - Revolutionizing industries through intelligent textile integration powered by advanced AI algorithms.
            </p>
            <p className="text-gray-300 mb-6">
        ...
        <div className="pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm mb-4 md:mb-0">
            © {new Date().getFullYear()} VECXA Technologies. All rights reserved.
          </p>
