...
const SEO: React.FC<SEOProps> = ({
  ...
  const currentUrl = `https://vexatech.com${location.pathname}`;
  const absoluteImageUrl = imageUrl.startsWith('http') ? imageUrl : `https://vexatech.com${imageUrl}`;
  ...
  const organizationStructuredData = {
    ...
    '@type': 'Organization',
    name: 'VECXA Technologies',
    url: 'https://vexatech.com',
    logo: 'https://vexatech.com/lovable-uploads/14ea3fe0-19d6-425c-b95b-4117bc41f3ca.png',
    description: 'Advanced AI-Driven Smart Textile Solutions',
    contactPoint: {
      '@type': 'ContactPoint',
      contactType: 'customer service',
      email: 'contact@vexatech.com'
    },
    sameAs: [
      'https://www.linkedin.com/company/vexa-technologies',
      'https://twitter.com/VEXATech'
    ]
  };
  ...
  const blogPostStructuredData = isBlogPost && publishDate ? {
    ...
    author: {
      '@type': 'Organization',
      name: author || 'VECXA Technologies',
      url: 'https://vexatech.com'
    },
    publisher: {
      '@type': 'Organization',
      ...
      logo: {
        '@type': 'ImageObject',
        url: 'https://vexatech.com/lovable-uploads/14ea3fe0-19d6-425c-b95b-4117bc41f3ca.png',
        width: 512,
        height: 512
      },
      url: 'https://vexatech.com'
  ...
  return (
    <Helmet>
      ...
      <meta property="og:site_name" content="VECXA Technologies" />
      <meta property="og:locale" content="en_US" />
      {isBlogPost && category && <meta property="article:section" content={category} />}
      {isBlogPost && publishDate && <meta property="article:published_time" content={publishDate} />}
      {isBlogPost && modifiedDate && <meta property="article:modified_time" content={modifiedDate} />}
      {isBlogPost && <meta property="article:publisher" content="https://vexatech.com" />}
      ...
      <meta name="twitter:site" content="@VEXATech" />
      <meta name="twitter:creator" content="@VEXATech" />
