            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="prose prose-lg max-w-none">
                ...
                <motion.div 
                  ...
                  className="mb-16"
                >
                  <h2 className="text-3xl font-bold mb-6">Why Join VECXA?</h2>
                  ...
                  <div className="bg-white rounded-xl border border-gray-200 p-8 shadow-sm mt-12">
                    <h3 className="font-bold text-xl mb-6">Contact Our VP of Business Development</h3>
                    <div className="bg-white rounded-xl p-6 border border-gray-200">
                      <div className="flex flex-col items-center text-center">
                        ...
                        <p className="text-gray-600 mb-4">VP of Business Development</p>
                        <p className="text-gray-500 text-sm mb-4">MBA (Wharton), Former Director at Nike Innovation Labs</p>
                        <div className="flex flex-col space-y-3">
                          <a href="mailto:partnerships@vexatech.com" className="flex items-center text-gray-700 hover:text-blue-600">
                          ...
                          <a href="tel:+15551238392" className="flex items-center text-gray-700 hover:text-blue-600">
